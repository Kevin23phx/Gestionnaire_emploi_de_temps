...
- **L'étudiant** d'un groupe/département d'une UFR de l'UJKZ, qui se déplace parfois pour un cours annulé ou déplacé faute d'avoir été informé à temps. *(**[V3]** — n'est plus un **utilisateur authentifié** mais un **visiteur public** : il consulte sans compte, en désignant son UFR, son département et son niveau, et peut conserver son programme en favori sur son propre appareil. C'est le changement d'audience central de la V3 : le système n'a plus à connaître ses étudiants pour les servir.)*
...
1. **[V3]** N'importe qui — étudiant, enseignant, parent, agent — peut **retrouver un programme sans compte**, en désignant l'UFR, le département puis le niveau concernés, et le consulter à tout moment, y compris sans connexion internet active.
