...
| FR-REF-22 `[V3.2, précisée V3.3]` | **« Filière » et « département » désignent la même chose** dans ce système (confirmé par le porteur de projet le 2026-09-07) : « Médecine et Spécialités médicales », « Pharmacie » et « Medecine » sont trois filières de l'UFR/SDS, au même rang. Il n'existe **aucun niveau hiérarchique** entre l'établissement et la filière. Le Système DOIT tenir un **référentiel des départements** rattachés à chaque établissement, alimenté par le référentiel officiel de l'UJKZ (53 départements sur 12 établissements). Deux départements d'un même établissement NE DOIVENT PAS pouvoir porter le même libellé, à la casse près. |
